  ...
  <div className='container'>
    <div className='container headShotDiv row'>
      ...
      <div className=''>
        ...
        <p>Also serving as a lawyer, and former United States Senate staffer I have been fortunate to live in great cities across the United States, but have settled in my forever home (and hometown), Atlanta, GA.</p>
